...
import main.java.com.ima.dev.service.getUsers;
...
public class checkCredentialServlet extends HttpServlet {
	...
	private static final Logger logger =  LogManager.getLogger( main.java.com.ima.dev.checkCredentialServlet.class);
