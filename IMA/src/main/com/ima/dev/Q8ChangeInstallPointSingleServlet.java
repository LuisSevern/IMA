...
public class Q8ChangeInstallPointSingleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			{
				if (addSuffix){
					WoRefNumber = Long.parseLong(request.getParameter("usedWoRefNumber")+"0"+request.getParameter("suffix"));				
				} else {
					WoRefNumber = Long.parseLong(request.getParameter("usedWoRefNumber"));				
				}
			}
		...
		try{			
			...
			{
				if (addSuffix2){
					WoRefNumber2 = Long.parseLong(request.getParameter("actualWoRefNumber")+"0"+request.getParameter("suffix2"));				
				} else {
					WoRefNumber2 = Long.parseLong(request.getParameter("actualWoRefNumber"));				
				}
			}
