...
<title>Swap Install Point</title>
...
function checklength(){
	var woRefNumber = document.getElementById('woRefNumber').value;
	var woRefNumber2 = document.getElementById('woRefNumber2').value;
	var MeterSN = document.getElementById('MeterSN').value;
	var MeterSN2 = document.getElementById('MeterSN2').value;
	
	if (woRefNumber.length == 0){
...
<div class="topmenuA"></div>
	...
	<div class="horizontalcssmenu">
		<ul id="cssmenu1">
			...
			<div class="toptitle">
				<h3>Electricity > Swap Install Point</h3>
			</div>
		<br style="clear: left;" />
	</div>
...
<div class="context">
<br>
	<form action="Q1PremiseDetailsServlet" method="get" onsubmit="return checklength()" >
        <table border="1" width="1024px">
            <tr>
                <td colspan="2" width="487px" valign="middle" bgcolor="#216d4a" height="14px"><h1>Premise Details:</h1></td>
                <td width="50px" height="14px"> </td>
                <td colspan="2" width="487px" valign="middle" bgcolor="#216d4a" height="14px"><h1>Premise Details:</h1></td>
            </tr>
            <tr>
                <td valign="middle" valign="bottom"><h2>WorkOrder ID:</h2></td>                                                                               
                <td>
                	<table>
                		<tr>
							<td>
            ...
            <tr>
                <td><h2>Smart Meter SN:</h2></td>
                <td><input class="txt" type="text" id="MeterSN" name="MeterSN" />
                <td width="50px"> </td>
                <td><h2>Smart Meter SN:</h2></td>
                <td><input class="txt" type="text" id="MeterSN2" name="MeterSN2" />
            </tr>
            <tr>
