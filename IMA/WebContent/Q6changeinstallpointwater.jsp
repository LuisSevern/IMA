...
<title>Change Install Point Water</title>
...
<!--
	...
	<div class="horizontalcssmenu">
		...
		<div class="toptitle">
			<h3>Water > Swap Install Point</h3>
		</div>
		<br style="clear: left;" />
	</div>
...
<jsp:include page="menu.jsp" flush="true">
	<jsp:param name="breadCrumb" value="Water > Swap Install Point" />
</jsp:include>


	<div class="context">
		<br>
		<form action="Q6ChangeInstallPointWaterServlet" method="get" onsubmit="return checklength('waterWoNumber','waterWoNumber2')">
<table border="1" width="1024px">
            <tr>
                <td colspan="2" width="487px" valign="middle" bgcolor="#001084" height="14px"><h1>Premise Details:</h1></td>
                ...
                <td ><h2>WorkOrder ID:</h2></td>
					...
					<td>
						<table>
							...
							<tr>
								<td> 
									<select name="waterWoprefix2" id="waterWoprefix2_id" onchange="changeSuffix2()">
										<option value="1">EXT</option>
										<option value="3">DUP</option>
									</select> 
								</td>
								<td>
									<input class="txt" type="text" name="waterWoNumber2" id="waterWoNumber2" onkeypress='validate(event)'/>
								</td>
								<td>
								</td>
								<td width="100px"> 
