...
<title>Change Water Meter / MIU</title>
...
<jsp:include page="menu.jsp" flush="true">
	<jsp:param name="breadCrumb" value="Water > Change Serial" />
</jsp:include>	

	<div class="context">
		<br>

		<form action="Q4ChangeWaterMIUMeterServlet" method="get" onsubmit="return checklength('waterWoNumber')">
			<table border="1">
				<tr>
				...
				<tr>
					<td colspan=2 align="right"><input class="btn" type="submit"
						name="changemeter" value="Change Meter Serial" /> <input
						class="btn" type="submit" name="changemiu"
						value="Change MIU Serial" />
					</td>
				</tr>
			</table>
			<h5>
