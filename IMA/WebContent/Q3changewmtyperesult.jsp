...
<title>Change Meter/MIU Type Result</title>
...
<!--  
	...
	<div class="horizontalcssmenu">
		...
		<div class="toptitle">
			<h3>Water > <a href="Q3changewmtype.jsp">Change Type</a> > Change Type Result</h3>
		</div>
		<br style="clear: left;" />
	</div>
...
<jsp:include page="menu.jsp" flush="true">
	<jsp:param name="breadCrumb" value="Water > Change Type Result" />
</jsp:include>
